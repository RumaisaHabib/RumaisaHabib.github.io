...
- **[SIGCOMM '23]**{: style="color: lime;" } [A Framework for Improving Web Affordability and Inclusiveness (***Rumaisa Habib***{: style="color: yellow;"}\*, Sarah Tanveer\*, Aimen Inam, Haseeb Ahmed, Ayesha Ali, Zartash Afzal Uzmi, Zafar Ayyub Qazi, Ihsan Ayyub Qazi)]({{ site.url }}/assets/papers/framework-for-improving-affordability.pdf){:target="_blank"}*[\*Joint first authors]*{: style="color: grey;" }[*[Code]*{: style="color: lime;" }](https://github.com/nsgLUMS/sigcomm2023-aw4a){:target="_blank"}
- **[TheWebConf '23]**{: style="color: lime;" } [A First Look at Public Service Websites from the Affordability Lens (***Rumaisa Habib***{: style="color: yellow;"}, Aimen Inam, Ayesha Ali, Ihsan Ayyub Qazi, Zafar Ayyub Qazi)]({{ site.url }}/assets/papers/public-sites.pdf){:target="_blank"} [*[Dataset]*{: style="color: lime;" }](https://github.com/nsgLUMS/public-service-sites){:target="_blank"} [*[Video summary]*{: style="color: lime;" }](https://youtu.be/Ni3GvG51mHo){:target="_blank"}
- **[HotNets '21]**{: style="color: lime;" } [Rethinking Web for Affordability and Inclusion (Ihsan Ayyub Qazi, Zafar Ayyub Qazi, Ayesha Ali, Muhammad Abdullah, ***Rumaisa Habib***{: style="color: yellow;"})]({{ site.url }}/assets/papers/rethinking-web-affordability-inclusion.pdf){:target="_blank"} [*[Presentation]*{: style="color: lime;" }](https://www.youtube.com/watch?v=5Vw9jF2tgVE&ab_channel=Hotnets2021){:target="_blank"}
