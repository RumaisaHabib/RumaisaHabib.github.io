...
- **[SIGCOMM '23]**{: style="color: lime;" } [A Framework for Improving Web Affordability and Inclusiveness (***Rumaisa Habib***{: style="color: yellow;"}\*, Sarah Tanveer\*, Aimen Inam, Haseeb Ahmed, Ayesha Ali, Zartash Afzal Uzmi, Zafar Ayyub Qazi, Ihsan Ayyub Qazi) *[\*Joint first authors]*{: style="color: grey;" }]({{ site.url }}/assets/papers/framework-for-improving-affordability.pdf){:target="_blank"} [[Code]](https://github.com/nsgLUMS/sigcomm2023-aw4a){:target="_blank"}
- **[TheWebConf '23]**{: style="color: lime;" } [A First Look at Public Service Websites from the Affordability Lens (***Rumaisa Habib***{: style="color: yellow;"}, Aimen Inam, Ayesha Ali, Ihsan Ayyub Qazi, Zafar Ayyub Qazi)]({{ site.url }}/assets/papers/public-sites.pdf){:target="_blank"} [[Dataset]](https://github.com/nsgLUMS/public-service-sites){:target="_blank"} [[Video summary]](https://youtu.be/Ni3GvG51mHo){:target="_blank"}
